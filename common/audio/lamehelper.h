...
typedef void (*lame_callback_proc)();
...
struct StaticParam_t {
  ...
  char* mp3;
  settings_t settings;
  lame_callback_proc callback_proc;
  lameHelper* lhObj;
};
...
class lameHelper {
 private:
  ...
  int encode_x(char*, char*, settings_t, lame_callback_proc callback);
 ...
 public:
  ...
  int encode(char* pcm_in, char* mp3_out, settings_t settings, lame_callback_proc callback_proc);
  void* encode(char* pcm_in, char* mp3_out, settings_t settings, lame_callback_proc callback_proc, bool async);

  //Decode a mp3 to pcm
  int decode(char* mp3_in, char* pcm_out);
  int decode(char* mp3_in, char* pcm_out, lame_callback_proc callback_proc);  
  void* decode(char* mp3_in, char* pcm_out, lame_callback_proc callback_proc, bool async);  
};
